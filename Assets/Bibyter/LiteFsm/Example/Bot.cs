    ...
    public sealed class Bot : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _fsm = new LiteFsm<State>()
                .AddActions(State.FindFood, update:FindFood_Update)
                .AddActions(State.GoHome, update:GoHome_Update)
                .AddActions(State.RunAway, enter:RunAwake_Enter, update:RunAway_Update);
        }
