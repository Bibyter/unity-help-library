...
namespace Example_Car
{
    ...
    public class Engine
    {
        ...
        /// </summary>
        float _tcsPowerReduction;
        public float TcsPowerReduction
        {
            get
            {
                return _tcsPowerReduction;// vc.drivingAssists.tcs.powerReduction;
            }
            set
            {
                _tcsPowerReduction = Mathf.Clamp01(value);
            }
        }
        ...
        public void Start()
        {
            if (/*!vc.fuel.HasFuel || (vc.damage.enabled && vc.damage.DamagePercent == 1f)*/false)
            {
        ...
        public float GetLoad()
        {
            ...
            float powerCoeff = Power / maxPower;
